    ...
    return {
      ...
      dict: {
            ...
            "Recommend": "推荐",
              ...
              "NumFeedbackFallbackItemBased": "条目相似推荐的反馈返回数量",
              "ExploreRecommend": "探索推荐方法",
              "EnableItemNeighborIndex": "启用向量索引进行近似条目邻居搜索",
              "ItemNeighborType": "条目邻居类型",
              "ItemNeighborIndexRecall": "近似条目邻居搜索的最小召回率",
              "ItemNeighborIndexFitEpoch": "近似条目邻居搜索的最大训练次数",
              ...
              "EnableItemBasedRecommend": "在离线推荐时启用基于条目的相似度推荐",
