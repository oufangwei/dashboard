  ...
  data() {
    return {
      items: [
        ...
        { icon: 'tag', name: '问题/活动标签的数量', key: '$.NumItemLabels' },
        { icon: 'trending_up', name: '热门问题/活动更新时间', key: '$.PopularItemsUpdateTime' },
        { icon: 'trending_up', name: '最新问题/活动更新时间', key: '$.LatestItemsUpdateTime' },
        ...
        { icon: 'travel_explore', name: '相邻问题/活动索引召回', key: '$.ItemNeighborIndexRecall' },
